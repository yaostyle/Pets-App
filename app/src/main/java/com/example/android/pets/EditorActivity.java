...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    // Perform the deletion of the pet in the db
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null
            ...
            // No need to create ContentValues
            return;
        }
        ...
        if (mCurrentPetUri == null) {
            // This is a NEW pet, so insert it
            Uri newUri = getContentResolver().insert(PetEntry.CONTENT_URI, values);

            if (newUri == null) {
                // if null, insertion failed
                Toast.makeText(this,
                        getString(R.string.editor_insert_pet_failed),
                        Toast.LENGTH_SHORT).show();
            } else {
                // Otherwise, the insertion was successfull
                Toast.makeText(this,
            ...
            // Show a toast
            if (rowsAffected == 0) {
                // If no rows were affected, then there was an error
                Toast.makeText(this,
